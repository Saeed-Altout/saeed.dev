...
export function HomeAboutSection() {
  return (
    <section
      ...
      className="grid min-h-svh lg:grid-cols-2 border-b border-border/40"
    >
      <div className="flex flex-col justify-center gap-6 container">
        <div className="max-w-xl mx-auto">
          ...
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 sm:mb-8 max-w-2xl mx-auto font-light leading-relaxed">
            ...
            <span className="text-primary font-semibold">Nest.js</span>. Focused
            on clean code, performance, and delivering business value.
          </p>
        </div>
      </div>
