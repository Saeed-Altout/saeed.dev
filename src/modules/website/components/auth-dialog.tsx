...
export function AuthDialog({ open, onOpenChange }: AuthDialogProps) {
  ...
  const { mutate: signIn, isPending: signInPending } = useSignInMutation();
          ...
          <TabsContent value="signin" className="space-y-4">
            <Form {...signInForm}>
              <form
                ...
                className="space-y-4"
              >
                <EmailField form={signInForm} isPending={signInPending} />
                <PasswordField
                  form={signInForm}
          ...
          <TabsContent value="signup" className="space-y-4">
            <Form {...signUpForm}>
              <form
                ...
                className="space-y-4"
              >
                <NameField form={signUpForm} isPending={signUpPending} />
                <EmailField form={signUpForm} isPending={signUpPending} />
                <PasswordField
                  form={signUpForm}
